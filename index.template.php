...
//we need those functions from earlier
...
<div id="page" class="hfeed">
	<div class="header" id="top">
    	<div id="other">
			...
			<div id="search">
				<form method="get" id="searchform" action="http://www.fireexitguild.com/">
    	...
    	<div id="logo">
        	<img src="http://www.fireexitguild.com/wp-content/themes/memeselection/images/logo.png" width="288" height="120">
        </div>
...
//		die($thumbnail);
        ...
        <div id="charname" class="class-<?=$class?>"><?=$name?></div>
        <?php else: ?>
		...
		<?php $menu = array((object) array('url' => "/", 'title' => "Home"),(object) array('url' => "Memes", 'title' => "Recruitment"),(object) array('url' => "", 'title' => "Dashboard"),(object) array('url' => "/", 'title' => "Forums"),(object) array('url' => "", 'title' => "Yum")); ?>
        <?php
            if (count($menu) > 0):
        ?>
